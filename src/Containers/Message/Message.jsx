                        ...
                        <div className="listof-users">
                            ...
                            <div className="listof-allusers">
                                {allusers && allusers.map((values, i) => {
                                    return (
                                        <div className="eachuser" onClick={() => startChat(values.uid, values.name, values.profile)}>
                                ...
                                <ul>
                                    {allmessages.map((values,i)=>{
                                        ...
                                        if(values.senderuid==userUid){
                                            return(
                                                <li className="mymessage">{values.Message}</li>
                                            )
                                        }   
                                        // else if(values.reciveruid==frienduid){
                                        //     return(
                                        //         <li className="friendmessage">{values.Message}</li>
                                        //     )
                                        // }   
                                        else{
                                            return(
